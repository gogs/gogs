...
1. **NO** direct modifications to `.css` files, `.css` files are all generated by `.less` files. You can regenerate `.css` files by executing `lessc --clean-css --source-map "public/less/gogs.less" public/css/gogs.min.css`.
