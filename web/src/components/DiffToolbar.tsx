import { Check, ChevronDown, Maximize2, Minimize2, Settings2, SlidersHorizontal } from "lucide-react";
import { type ReactNode, forwardRef } from "react";

import { Popover, PopoverContent, PopoverTrigger } from "@/components/ui/popover";
import { Tooltip, TooltipContent, TooltipTrigger } from "@/components/ui/tooltip";
import { cn } from "@/lib/utils";
import type { DiffFileStatus } from "@/pages/CommitDiff.search";

export type DiffStyle = "unified" | "split";

// Whitespace UX vocabulary, including the explicit "show" state that the URL
// represents as absence. See `CommitDiff.search.ts` for the URL-side type.
