...
> **Note:** This is the modern, security-focused Docker image. For the legacy image with OpenSSH support, see [docker-legacy/README.md](../docker-legacy/README.md).
