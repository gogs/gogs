...
- **Domain**: fill in with Docker container IP(e.g. `192.168.99.100`). But if you want to access your Gogs instance from outside world, please fill in with corresponding public domain or IP address.
