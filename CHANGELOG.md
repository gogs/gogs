...
- _Security:_ Forgeable "remember me" cookie allowed full authentication bypass for any user whose database row was known to the attacker. The auto-login flow now relies on the server-side session record rather than a cookie derived from the user's password hash. [#8267](https://github.com/gogs/gogs/pull/8267) - [GHSA-4pph-25p3-pw73](https://github.com/gogs/gogs/security/advisories/GHSA-4pph-25p3-pw73)
...
- The `[security] COOKIE_REMEMBER_NAME` and `[security] COOKIE_USERNAME` configuration options. Remember-me state is now stored server-side in the session. [#8267](https://github.com/gogs/gogs/pull/8267) - [GHSA-4pph-25p3-pw73](https://github.com/gogs/gogs/security/advisories/GHSA-4pph-25p3-pw73)
