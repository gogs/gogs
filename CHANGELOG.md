...
- JSON responses used an invalid `application/json; charset=UTF-8` media type; the `charset` parameter is not defined for this media type and is now omitted. [#8413](https://github.com/gogs/gogs/pull/8413)
