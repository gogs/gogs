...
- Markdown alerts, i.e., block quotes that start with `[!NOTE]`, `[!TIP]`, `[!IMPORTANT]`, `[!WARNING]`, or `[!CAUTION]`, are now rendered as highlighted callouts. [#8388](https://github.com/gogs/gogs/issues/8388)
