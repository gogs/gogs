...
- The `[security] COOKIE_REMEMBER_NAME` and `[security] COOKIE_USERNAME` configuration options. Remember-me state is now stored server-side in the session. [#8269](https://github.com/gogs/gogs/pull/8269) - [GHSA-4pph-25p3-pw73](https://github.com/gogs/gogs/security/advisories/GHSA-4pph-25p3-pw73)
