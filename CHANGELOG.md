...
- _Security:_ Cross-tenant LFS content leak where a user with write access to one repository could claim an object OID owned by a private repository without possessing the actual content. [#PLACEHOLDER](https://github.com/gogs/gogs/pull/PLACEHOLDER) - [GHSA-6p9m-q3jp-47h4](https://github.com/gogs/gogs/security/advisories/GHSA-6p9m-q3jp-47h4)
