...
func NewRepoContext() {
	...
	RemoveAllWithNotice("Clean up repository temporary data", filepath.Join(conf.AppDataPath, "tmp"))
}
...
func (repo *Repository) LocalCopyPath() string {
	return path.Join(conf.AppDataPath, "tmp/local-repo", com.ToStr(repo.ID))
}
