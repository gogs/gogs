...
// create creates a new repository record in the database. Fields of "repo" will
// be updated in place upon insertion. It returns ErrNameNotAllowed when the
// repository name is not allowed, or ErrRepoAlreadyExist when a repository with
// same name already exists for the owner.
