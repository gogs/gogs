...
func isRepositoryGitPath(path string) bool {
	return strings.HasSuffix(path, ".git") || strings.HasSuffix(path, ".git.") || strings.Contains(path, ".git"+string(os.PathSeparator) || strings.Contains(path, ".git."+string(os.PathSeparator)
}
