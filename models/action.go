...
func init() {
	IssueCloseKeywordsPat = regexp.MustCompile(assembleKeywordsPattern(base.IssueCloseKeywords))
	IssueReopenKeywordsPat = regexp.MustCompile(assembleKeywordsPattern(base.IssueReopenKeywords))
